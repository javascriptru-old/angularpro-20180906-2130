 ...
 * found in the LICENSE file at https://angular.io/license
 */
e.ngExpressEngine=function c(e){var c=t.platformDynamicServer().injector.get(n.CompilerFactory).createCompiler([{providers:[{provide:o.ResourceLoader,useClass:u,deps:[]}]}]);return function(o,u,l){u.providers=u.providers||[];try{var p=u.bootstrap||e.bootstrap;if(!p)throw new Error("You must pass in a NgModule or NgModuleFactory to be bootstrapped");e.providers=e.providers||[];var f=e.providers.concat(u.providers,function d(e,r){var n=[{provide:i.REQUEST,useValue:e}];return r&&n.push({provide:i.RESPONSE,useValue:r}),n}(u.req,u.res),[{provide:t.INITIAL_CONFIG,useValue:{document:u.document||function g(e){return s[e]=s[e]||r.readFileSync(e).toString()}(o),url:u.url||u.req.originalUrl}}]);(function v(e,r){return new Promise(function(o,t){if(e instanceof n.NgModuleFactory)o(e);else{var i=a.get(e);i?o(i):r.compileModuleAsync(e).then(function(r){a.set(e,r),o(r)},function(e){t(e)})}})})(p,c).then(function(e){return t.renderModuleFactory(e,{extraProviders:f})}).then(function(e){l(null,e)},function(e){l(e)})}catch(e){l(e)}}},Object.defineProperty(e,"__esModule",{value:!0})});